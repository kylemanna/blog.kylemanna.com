...
I use [obnam](http://liw.fi/obnam/bugs) from remote back-ups and it works great.  Every night it copies the delta from the last back-up to [Dreamhost](http://wiki.dreamhost.com/Personal_Backup) and encrypts my data on the fly.  In the event my apartment burns down I'll have my most important data.  The rest of my data is backed-up using rsync to another local harddrive which is considerably cheaper and significantly faster.
